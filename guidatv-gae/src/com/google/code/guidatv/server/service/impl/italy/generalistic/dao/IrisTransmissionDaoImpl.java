...
public class IrisTransmissionDaoImpl  {
    ...
    public Map<Date, List<Transmission>> getTransmissions(Date day) {
        ...
        try {
            ...
            retValue.put(
                    firstDate,
                    getTransmissions(firstDate, (Element) dayNodeList.item(0), numberFormat));
            retValue.put(
                    secondDate,
                    getTransmissions(secondDate, (Element) dayNodeList.item(1), numberFormat));
    ...
    private List<Transmission> getTransmissions(Date day, Element dayNode,
