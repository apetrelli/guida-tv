...
public class TransmissionWidget extends Composite implements HasResizeHandlers {
    ...
    public TransmissionWidget(final Transmission transmission) {
        ...
        googleLink.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                Window.open(
                        new UrlBuilder().setProtocol("http")
                                .setHost("www.google.com").setPath("/search")
                                .setParameter("q", transmission.getName().replaceAll(" ", "+"))
        ...
        wikipediaLink.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                Window.open(
                        new UrlBuilder().setProtocol("http")
                                .setHost("it.wikipedia.org").setPath("/w/index.php")
                                .setParameter("search", transmission.getName().replaceAll(" ", "+"))
                                .buildString(), "_blank", null);
            }
        });
        imdbLink.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                Window.open(
                        new UrlBuilder().setProtocol("http")
                                .setHost("www.imdb.com").setPath("/find")
                                .setParameter("s", "tt")
                                .setParameter("q", transmission.getName().replaceAll(" ", "+"))
                                .buildString(), "_blank", null);
            }
